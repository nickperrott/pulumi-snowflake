...
class BaseDynamicProvider(ResourceProvider):
    ...
    def create(self, inputs):
        ...
        info(f"Creating object {self.logging_name}...")
        ...
        info(f"Creation of {self.logging_name} with name {validated_name} successful")
    ...
    def diff(self, id, olds, news):
        ...
        """
        info(f"Diffing object {self.logging_name} with name {id}...")
        ...
        info(f"Diff of {self.logging_name} with name {id} has changes: {len(changed_fields) > 0}")
    ...
    def delete(self, id, props):
        info(f"Deleting object {self.logging_name} with name {id}...")
        sql = self.generate_sql_drop_statement(id, props, self._create_jinja_environment())
        self._execute_sql(sql)
        info(f"Deletion of object {self.logging_name} with name {id} successful")
